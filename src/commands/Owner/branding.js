        ...
        collector.on('collect', async (interaction) => {
            if (interaction.user.id !== message.author.id) {
                const errorDisplay = new TextDisplayBuilder()
                    .setContent(`${emoji.cross || '❌'} Only ${message.author.username} can use this!`);
            ...
            if (interaction.customId === 'open_branding_form') {
                            ...
                            try {
                                ...
                                if (modalData.avatarUrl || modalData.bannerUrl || modalData.bio) {
                                    try {
                                        ...
                                        successText += `${emoji.warn || '⚠️'} Could not update avatar/banner/bio: ${apiError.message}\n`;
                                    }
                                }
                ...
                try {
                    ...
                    try {
                        ...
                        resetText += `${emoji.warn || '⚠️'} Could not reset avatar/banner/bio: ${err.message}\n`;
                    }
