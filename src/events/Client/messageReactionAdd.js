...
module.exports = {
    ...
    run: async (client, reaction, user) => {
        ...
        try {
            await user.send(`<:giveaway:${ENTER_EMOJI_ID}> You've entered the giveaway for **${giveaway.prize}**! Good luck!`);
            client.logger.log(`[GiveawayDM] Sent entry DM to ${user.tag}`, 'info');
        } catch (e) {
